...
class LitDataHumanObject(LitDataHuman):
    def __init__(
        ...
        scene_name,        
        cfg,
        near_bkg: Optional[float] = None,
        far_bkg: Optional[float] = None,        
    ):

        super(LitDataHumanObject, self).__init__(cfg)      
        self.near_bkg = 0.0 if near_bkg is None else near_bkg
        self.far_bkg = 1.0 if far_bkg is None else far_bkg          
