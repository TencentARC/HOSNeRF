...
class HumanSingleImageDDPSampler(DDPSampler):
    def __init__(
        self,
        batch_size,
        num_replicas,
        ...
        super(HumanSingleImageDDPSampler, self).__init__(batch_size, num_replicas, rank, tpu)
        self.N_pixels = N_pixels
        self.N_img = N_img
        self.epoch_size = epoch_size
        self.precrop = precrop
...
class MultipleImageDDPSampler(DDPSampler):
    ...
    def __iter__(self):
        ...
        print("num_replicas is: ", self.num_replicas)
