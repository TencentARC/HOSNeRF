...
class Dataset(torch.utils.data.Dataset):
    def __init__(
        ...
        if bgcolor == None: # only train bgcolor=None
            self.is_train = True
    ...
    @staticmethod
    def select_rays(select_inds, rays_o, rays_d, ray_img, ray_grid, near, far):
        ...
        far = far[select_inds]
        return rays_o, rays_d, ray_img, ray_grid, near, far
    
    @staticmethod
    def select_rays_original(select_inds, rays_o, rays_d, ray_img, near, far):
        rays_o = rays_o[select_inds]
        rays_d = rays_d[select_inds]
        ray_img = ray_img[select_inds]
        near = near[select_inds]
    ...
    def sample_patch_rays(self, img, H, W,
                          ...
                          rays_o, rays_d, ray_img, ray_grid, near, far):
        ...
        rays_o, rays_d, ray_img, ray_grid, near, far = self.select_rays(
            select_inds, rays_o, rays_d, ray_img, ray_grid, near, far)
    ...
    def sample_patch_rays_original(self, img, H, W,
        ...
        rays_o, rays_d, ray_img, near, far = self.select_rays_original(
    ...
    def __getitem__(self, idx):
        ...
        if 'motion_bases' in self.keyfilter:
            ...
            if time > 0.005 and self.is_train:
                ...
                E_prev = apply_global_tfm_to_camera(
                        E=E_prev, 
